...
**In progress.** Proxmox is running with four LXC containers deployed. k3s, Windows VMs, and snapshot discipline are not yet in place.

| Component | Status |
| --- | --- |
| Proxmox hypervisor | ✅ Installed, VLAN-aware bridge configured |
| LXC containers (4) | ✅ CT 100 (webapp), CT 101 (libretranslate), CT 103 (huckleberry), CT 104 (discord-bot) |
...
| 104 | discord-bot | Discord Music Bot (Docker Compose: bot + Lavalink) | Personal & Self-Hosted Services | [[PROJECTS/Homelab/homelab/Personal & Self-Hosted Services/Discord-Music-Bot\|Discord-Music-Bot]] |
